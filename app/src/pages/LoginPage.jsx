    ...
    <AuthLayout>
      <div className="auth-form-container animate-fade-in-up">
        <div className="auth-form-header">
          ...
          <p className="auth-form-subtitle">Sign in to continue to your workspace.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          <div className="auth-form-options">
            ...
            <a href="#" className="auth-forgot-link" onClick={handleForgotPassword}>Forgot password?</a>
          </div>
