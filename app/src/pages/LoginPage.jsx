...
export default function LoginPage() {
  ...
  const handleGoogleLogin = () => {
    addToast('Google OAuth integration coming soon.', 'info')
  }

  const handleGitHubLogin = () => {
    addToast('GitHub OAuth integration coming soon.', 'info')
  }

  const handleForgotPassword = (e) => {
    e.preventDefault()
    addToast('Password reset email sent! (demo)', 'success')
  }
    ...
    <AuthLayout>
      <div className="flex flex-col gap-6 animate-[fadeInUp_0.5s_ease_both]">
        <div className="mb-1.5">
          <h2 className="text-[1.625rem] font-bold text-text-primary mb-1.5 tracking-[-0.01em]">Welcome back</h2>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4" noValidate>
          <div className="flex flex-col gap-1.5">
            <label htmlFor="login-email" className="text-[0.8125rem] font-medium text-text-secondary">Work email</label>
          ...
          <div className="flex flex-col gap-1.5">
            <label htmlFor="login-password" className="text-[0.8125rem] font-medium text-text-secondary">Password</label>
            <div className="relative flex items-center">
          ...
          <div className="flex items-center justify-between -mt-1">
            <label className="flex items-center gap-2 text-[0.8125rem] text-text-muted cursor-pointer select-none">
              <input
                type="checkbox"
                className="w-[15px] h-[15px] accent-accent-primary cursor-pointer"
                checked={remember}
        ...
        <p className="text-center text-[0.8125rem] text-text-muted mt-1">
          New to Netevo?{' '}
          <Link to="/register" className="text-text-primary font-semibold transition-colors hover:text-accent-hover">Create an account</Link>
        </p>
